...
We primarily evaluate existing methods based on accuracy (ACC), F1 score (macro), and Fréchet Video Distance (FVD) metrics. For detailed experimental results, please refer to the paper. If you need the baseline prediction outputs, feel free to contact me.
